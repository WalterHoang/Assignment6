...
$(document).keypress(function(event) {
	// 5-key press calculator controls
	if (event.key == "w") {					// moves cursor up
		selectUp();
	} else if (event.key == "a") {			// moves cursor left
		selectPrevious();
	} else if (event.key == "s") {			// moves cursor down
		selectDown();
	} else if (event.key == "d") {			// moves cursor right
		selectNext();
	} else if (event.key == "e") {			// activates whatever the cursor is currently selecting
		clickSelectedItem();
	}
	// 3-key press calculator controls
	if (event.key == "u") {			// moves cursor left
		selectPrevious();
	} else if (event.key == "o") {			// moves cursor right
		selectNext();
	} else if (event.key == "i") {			// activates whatever the cursor is currently selecting
		clickSelectedItem();
	}
})
